...
def intf_send_mail(to, subject, text, files=None):
    ...
    :return:
    """
    server = {'name': 'smtp.exmail.qq.com', 'user': 'spider.alarm@mi-me.com', 'passwd': 'cimY32E9B77eKNxX', 'port': 25}
...
if __name__ == '__main__':
    ...
    to_ = ['yongjun.wang@mi-me.com']
    subject_ = '可能有问题了哥'
    text_ = '可口可乐'
    try:
        intf_send_mail(to_, subject_, text_)
